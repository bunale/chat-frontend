<template>
    <div class="video-call-container">
        ...
        <div class="caller-info">
            <van-image :src="route.params.avatar" round width="60" height="60" class="caller-avatar" />
...
const initWebRTC = async () => {
    try {
        console.log('videoCallStore: ', videoCallStore.offerMessage, videoCallStore.targetUserId)
...
const resolveOffer = async (message: any) => {
    ...
    await createPeerConnection(targetUserId);
    await peerConnection.value?.setRemoteDescription(new RTCSessionDescription(message.data.data))
