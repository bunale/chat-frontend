        ...
        <div class="chat-body">
            ...
            <div class="chat-footer fixed-bottom">
                <div class="input-wrapper">
                    ...
                    <van-field v-model="inputMessage" type="textarea" placeholder="请输入消息" :border="false" :rows="1"
                        :autosize="{ maxHeight: 120, minHeight: 20 }" class="message-input" />
                    <van-icon name="smile-o" class="smile-icon" />
                    <!-- 使用 v-if/v-else 切换显示 -->
                    <van-button v-if="inputMessage.trim()" size="mini" type="primary" class="send-btn"
            ...
            <van-swipe :show-indicators="true">
                <van-swipe-item v-for="(page, pageIndex) in actionPages" :key="pageIndex">
                    <div class="grid-container">
                        <div v-for="(action, index) in page" :key="index" class="grid-item"
